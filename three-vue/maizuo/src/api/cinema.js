...
// 获取某天某电影影院列表
export const getTimeCinemaList = (cityId, cinemaIds) => {
  return request({
    method: "post",
...
// 获取某个影院的基本信息
export const getCinemaInfo = (params = {
  cid: 7828
}) => {
  return request({
...
export const getSchedule = (params) => {
  return request({
    url: `/gateway/?scheduleId=${params}&k=4836439`,
    data: {
      xHost: 'mall.film-ticket.schedule.info',
      // scheduleId: params
    }
  })
}
...
export const getScheduleData = (params) => {
  return request({
    url: `/gateway/?scheduleId=${params}&k=4836439`,
    data: {
      xHost: 'mall.film-ticket.seat.list',
      // scheduleId: params
    }
  })
}
...
// 获取某个影院下的所有电影列表
export const getCinemaFilms = (params = {
  cid: 7828
}) => {
  return request({
    url: `/gateway/?cinemaId=${params.cid}&k=4698761`,
...
// 获取某个影院下某个电影的某天播放时间
export const getCinemaFilmSchedule = (params = {
  fid: 4795,
  cid: 4722,
  date: 1570636800
}) => {
